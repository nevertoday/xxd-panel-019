...
**Panel 019**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **사진 속 특정 피사체와 관계를 알아볼 수 있는 모더니즘 일러스트로 재구성합니다**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
