...
1. **TOP_BOTTOM:** source photo above, transformed illustration below; exact equal height; default final canvas 3:4.
2. **LEFT_RIGHT:** source photo left, transformed illustration right; exact equal width; default final canvas 3:2.
3. **DESIGN_ONLY:** the source photo remains reference evidence but is not visible; the transformed illustration fills the entire canvas with no seam; default final canvas 3:4.
