...
That frustration is why I made **Panel 019**. It does not press a template onto your image. It first works out what must not be lost, then translates it into **Reconstruct a specific photographed subject and relationship as a modernist illustration that remains recognisable**.
...
<table>
  ...
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 019 Sample 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 019 Sample 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 019 Sample 8"></td>
  </tr>
</table>
