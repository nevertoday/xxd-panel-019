...
لهذا الإحباط صنعت **Panel 019**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **إعادة بناء الموضوع والعلاقة المحددين في الصورة كإيضاح حداثي يبقى قابلاً للتعرّف**.
