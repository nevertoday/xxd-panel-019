...
019 は実行骨格を [XXD Panel 016](https://github.com/nevertoday/xxd-panel-016) と共有し、必要な美学差だけを残しています。

| 019 | 016 |
| --- | --- |
| 判別できる被写体＋幾何学的階層 | 小さな核＋ひとつの運動場 |
| 3–5 色のレトロモダニズム平面イラスト | 2–3 色のリソグラフ／シルクスクリーン |
| 正負形、スケール差、硬質な色面 | 大きな余白、運動軌跡、物理的な粒子 |
