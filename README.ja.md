...
| モード | 既定キャンバス | 出力 |
| --- | ---: | --- |
| `top-bottom` | 3:4 | 上に元写真、下に 019 イラスト。高さを厳密に 50/50 分割 |
| `left-right` | 3:2 | 左に元写真、右に 019 イラスト。幅を厳密に 50/50 分割 |
| `design-only` | 3:4 | 元写真を表示しない、一枚の完成イラスト |
...
文字は既定オンです。自動コピーは “Memory” “Dream” “Journey” のような汎用語へ逃げず、画面上の事実、関係の緊張、根拠のある含意から、写真を見直すきっかけになるタイトルを探します。
